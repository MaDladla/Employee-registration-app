import pic from './Pictures/R (6).jpg'
import {
  Link
...
<nav class= "head-right">
 <li> <Link to="/contactus">Contact us  </Link></li>  
  ...
  <div class="container">
   <div class="left">
     <img src={pic} alt="Pictures" width="400" height="330" class="picture"/>
    <h1 class="natural">Be natural, be beautiful,<br/> be you</h1>
</div>
<div class="right">
  <h1>Welcome to</h1>
<h2>Cosmatic Trip</h2>
...
<Link to="/landPage" type="submit" class="signup" >Sign in</Link>
